...
class Uploader
{
    ...
    */
    ...
    private function upFile()
    {
        ...
        $this->fileName = md5(date("YmdHis",time()) . mt_rand(1000, 9999)).$this->fileType;
        $this->fullName = $this->config['pathFormat'].'/'.$this->fileName;  //图片资源url
        ...
        //移动文件
        if (!(move_uploaded_file($file["tmp_name"], $this->filePath.$this->fileName) && file_exists($this->filePath))) { //移动失败
