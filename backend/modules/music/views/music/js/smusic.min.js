...
!function (a) {
    ...
    j.prototype = {
        config: {musicList: [], defaultVolume: .7, defaultIndex: 0}, createListDom: function () {
            ...
            this.audioDom.removeEventListener("canplay", f, !1), clearInterval(i), this.musicDom.bufferProcess.style.width = "0px", this.musicDom.curProcess.style.width = "0px", this.audioDom.src = c.src, this.musicDom.cover.innerHTML = '<img src="' + c.cover + '" title="' + c.title + " -- " + c.singer + '">', this.musicDom.title.innerHTML = "<strong>" + c.title + "</strong><small>" + c.singer + '</small><a href="'+c.url+'" download="'+c.title+'.mp3"><i title="下载歌曲" class="aa layui-icon layui-icon-download-circle" ></i></a>' +
                ' <a onclick="usesong('+c.id+')"><i title="应用歌曲" song-id="'+c.id+'" class=" layui-icon layui-icon-add-circle-fine aa"></i></a>';
