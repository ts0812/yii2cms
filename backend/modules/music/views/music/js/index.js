layui.config({
	...
	$(window).one("resize",function(){
		$(".layui-default-add").click(function(){
            location.href="<?= yii\helpers\Url::to(['create']); ?>";
		});
	}).resize();
    ...
    //lrc 编辑
    $("body").on("click",".layui-default-lrc",function(){
    ...
    //pv记录
    $("body").on("click",".layui-default-pv",function(){  //查看
        var href = $(this).attr("href");
        console.log(href);
        var index = layui.layer.open({
            title : "查看访问记录",
    ...
    //pv记录
    $("body").on("click",".layui-default-comment",function(){  //查看
        var href = $(this).attr("href");
        console.log(href);
        var index = layui.layer.open({
            title : "查看评论",
	...
	$("body").on("click",".layui-default-delete",function(){  //删除
        var href = $(this).attr("href");
		layer.confirm('确定删除此项吗？',{icon:3, title:'提示信息'},function(index){
